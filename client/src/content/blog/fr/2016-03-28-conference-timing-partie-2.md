...
excerpt: "Le cahier de laboratoire électronique : une innovation qui procure des
  gains évidents et qui ne prend pas, pourquoi ? Une étude de cas sur le timing
  de l'innovation."
...
* Base de connaissance partageable et sur laquelle on peut faire des recherches
* Suppression de la manipulation du papier
* Amélioration de la qualité et aspect normatif
* Intégration aux autres éléments du système d'information
* Collecte des données des instruments
* Intégration de la cheminformatique
* Support des workflows (processus signature, collaboration multi-discipline)
* …

\[youtube:H_QOic2UxeU]

#### Comment expliquer la non adoption de cette innovation ?
